...
export default function ProjectDetail() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in">
      <Link href={project.category === "Game Development" ? "/game-design" : project.category === "Education" ? "/education" : project.category === "Competitive Gaming" ? "/competitive-gaming" : "/computer-science"}>
